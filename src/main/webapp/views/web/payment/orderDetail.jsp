    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="card shadow-lg p-4 text-center" style="max-width: 450px;">
            ...
            <div class="mt-3 text-start">
                ...
                <p><strong>Transaction Time:</strong> <span id="transactionDate">${transactionDate}</span></p>
                <p><strong>Transaction Code:</strong> <span id="transactionNo">${transactionNo}</span></p>
            </div>

            <div class="mt-4">
                <a href="/home" class="btn btn-primary w-100">Return to Home</a>
                <a href="/completedorder?orderId=${bookingId}" class="btn btn-outline-success w-100 mt-2">View Order Details</a>
            </div>
        </div>
    </div>
