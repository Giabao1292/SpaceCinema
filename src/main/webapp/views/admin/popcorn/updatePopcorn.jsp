...
<main>
    <div class="container-fluid px-4">
        <div class="container mt-4">
            <h2 class="font-monospace">Update Snack</h2>
            <c:set var="s" value="${snack}" />
            <form action="/admin-home/popcorn" method="post">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="snack" placeholder="Enter snack" name="name" value="${s.name}" required>
                    </div>
                    <!-- Price -->
                    <div class="col-md-4">
                        <label for="snackPrice" class="form-label">Price</label>
                        <input type="number" class="form-control" id="snackPrice" placeholder="Enter price" name="price" value="${s.price}" required>
                    </div>
                    <!-- Type -->
                    <div class="col-md-4">
