                ...
                <div class="d-flex flex-column align-items-center align-items-md-start text-center text-md-start">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="d-flex gap-3">
                            <a href="#!">
                                <img src="/static/web/assets/img/androi-download.png" alt="Android Download" class="img-fluid rounded-3" width="120"/>
                            </a>
                            <a href="#!">
                                <img src="/static/web/assets/img/appstore-download.png" alt="App Store Download" class="img-fluid rounded-3" width="130"/>
                            </a>
                        </div>
                    </div>
                </div>
